...
all_datetimes <- c("2023-07-08 08:00:00",
                   "2023-07-08 12:00:00",
                   "2023-07-08 16:00:00",
                   "2023-07-08 20:00:00",
                   "2023-07-08 00:00:00",
...
logfile <- "Output/parameter_optimisation/optimisation_log_CMA-ES_20230708-6timesteps_maxit5_with_verticals_and_params_from_lit.csv"
...
# INPUT DRIVERS #
#################
create_input_drivers(datetime = "2023-07-08 00:00:00") # random datetime, this will be overwritten
